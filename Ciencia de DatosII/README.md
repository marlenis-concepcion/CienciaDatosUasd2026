...
|---|---|---|---|---|---|
| I | [01 · SVM reproducible](Unidad%20I/Ejercicio%2001/README.md) | Ionosphere (UCI) | Pipeline SVM, CV estratificada / stratified CV | F1 macro **0.938** vs 0.391 baseline | 15 |
| I | [02 · Ensambles y Green AI](Unidad%20I/Ejercicio%2002/README.md) | Ionosphere (UCI) | SVM, PCA, RF, GB; Pareto de 4 objetivos / 4-objective Pareto | GB-50: F1 **0.922**, 50 KB, 0.012 ms/fila | 15 |

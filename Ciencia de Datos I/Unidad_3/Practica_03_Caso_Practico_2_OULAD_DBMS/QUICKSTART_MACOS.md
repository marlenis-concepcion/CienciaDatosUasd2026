...
```bash
cd "/PATH/CienciaDatosUasd2026/Ciencia de Datos I/Unidad_4/Practica_04_Proyecto_Final_OULAD"
```
...
```
/PATH/CienciaDatosUasd2026/Ciencia de Datos I/Unidad_4/Practica_04_Proyecto_Final_OULAD/docs/Articulo_Cientifico_OULAD_APA7.docx
```

...
```bash
cd "CienciaDatosUasd2026/Ciencia de Datos I/Unidad_2/Practica_02_Sakila_CRUD_ORM"
open index.html
```
...
```bash
cd "CienciaDatosUasd2026/Ciencia de Datos I/Unidad_2/Practica_02_Sakila_CRUD_ORM/caso_practico_2_sakila_crud_orm"
